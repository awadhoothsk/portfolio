...
const About: React.FC = () => (
  <section className="about-section">
    <h2>About Me</h2>
    <p>
      I'm Awadhooth Shrinivas Kulkarni, a Full Stack Developer driven by curiosity, creativity, and a deep love for building digital experiences that solve real-world problems.
